...
def full_get_cells_by_patients(adata, patient_col="donor_id",label_col="reported_diseases",subsample_patient_ratio=1.0,n_feats=None,filter_genes=False,n_cells=None,**kwargs):
...
def get_cells_by_patients(adata_path,patient_col="donor_id",label_col="reported_diseases",subsample_patient_ratio=1.0,n_feats=None,max_cells = None,filter_genes=False,**kwargs):
    global adata
    ...
    return distributions, disease_labels, points, point_labels, disease_labels, celltype_node_label, np.concatenate(patient_labels)


#TODO check diffs between cells load funcs of patient
def get_cells_by_patients_2(adata_path,patient_col="donor_id",label_col="reported_diseases",subsample_patient_ratio=1.0,n_cells=1000,pca_components=None,filter_genes=False,**kwargs):
    adata = sc.read_h5ad(adata_path+".h5ad")
...
def get_cells_by_patients_3(adata_path,patient_col="donor_id",label_col="reported_diseases",subsample_patient_ratio=0.25,n_feats=None,filter_genes=False,**kwargs):
    global adata
